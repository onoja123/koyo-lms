...
const { createArticle, timeline, deleteArticle,
    UserArticles, articleId, editArticle , getAllArticles} = require('../controller/articleController');

const { like,unlike } = require('../controller/likeController');
const { BookMark, unBookMarked ,Bookedby } = require('../controller/bookmarkedController');
const { createComment, getComment, updateComment, deleteComment } = require('../controller/commentController');
const {followUser, unfollow , followers , follows } = require('../controller/followController') ; 
